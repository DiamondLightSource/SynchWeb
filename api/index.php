...
function setupApplication($mode): Slim
{
    ...
    $app->get('/options', function () use ($app) {
        global $mode, $motd, $authentication_type, $cas_url, $cas_sso, $sso_url, $package_description,
            ...
            $shipping_service_app_url, $use_shipping_service, $use_shipping_service_incoming_shipments,
        ...
        $app->response()->body(json_encode(array(
            ...
            'redirects' => $redirects,
            'shipping_service_app_url' => $use_shipping_service ? $shipping_service_app_url : null,
            'shipping_service_app_url_incoming' => $use_shipping_service_incoming_shipments ? $shipping_service_app_url : null,
