define(['marionette', 'views/table',
    ...
    return Marionette.View.extend({
        ...
        onRender: function() {
            ...
            this.getRegion('onl').show(new TableView({ collection: this.online, columns: columns, search: false, tableClass: 'users', pages: true, backgrid: { emptyText: 'No users online' } } ))
            this.getRegion('act').show(new TableView({ collection: this.last, columns: columns, search: false, tableClass: 'activity' }))
        },
