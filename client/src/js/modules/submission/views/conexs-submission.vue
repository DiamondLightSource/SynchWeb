<template>
  <div>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    <span>Cluster status: {{ clusterStatus }}</span
    >&nbsp;&nbsp;&nbsp;<i
      v-if="
    ...
    >
      ...
      <input ref="inputFile" type="file" @change="setInputFile($event)" />
      <button
        ref="clearInputFile"
        type="button"
        name="clearInputFile"
      ...
      <section id="orcaTab" :style="{ display: orcaDisplay }">
        <div style="float:right; width:40%; height:30%">
          ...
          <span
            ...
            <a href="https://www.kofo.mpg.de/en/research/services/orca"
              >https://www.kofo.mpg.de/en/research/services/orca</a
            ></span
          >
          <br />
          <span
            >ORCA manual:
            <a href="https://www.kofo.mpg.de/412442/orca_manual-opt.pdf"
              >https://www.kofo.mpg.de/412442/orca_manual-opt.pdf</a
            ></span
          >
          <br />
          <span
            >ORCA input library website:
            <a href="https://sites.google.com/site/orcainputlibrary/home"
              >https://sites.google.com/site/orcainputlibrary/home</a
            ></span
          >
          <br /><br />
          <p>
          ...
          <p>
            <i
              ...
              Molecular Science 2, 73 (2012).</i
            >
          </p>
          <p>
            <i
              >F. Neese, Wiley Interdisciplinary Reviews: Computational
              Molecular Science 8, e1327 (2018).</i
            >
          </p>
          <br />
          <p>
            In general, the input file is a free format ASCII file and can
            contain one or more keyword lines that start with a "!" sign, one or
            more input blocks enclosed between an "%" sign and "end" that
            provide finer control over specific aspects of the calculation, and
            finally the specification of the coordinates for the system along
            with the charge and multiplicity provided either with a %coords
            block, or more usually enclosed within two "*" symbols. Here is an
            example of a simple input file that contains all three input
            elements:
          </p>
          <br />
          ...
          <p>
            %maxcore 5024 # global scratch memory limit (in MB) per processing
            core.
          </p>
          <br />
          ...
          <p>
            The input may contain several blocks, which consist of logically
            related data that can be user controlled. The program tries to
            choose sensible default values for all of these variables. However,
            it is impossible to give defaults that are equally sensible for all
            systems. In general the defaults are slightly on the conservative
            side and more aggressive cutoffs etc. can be chosen by the user and
            may help to speed things up for actual systems or give higher
            accuracy if desired. One-liner explanation (starts with !, order of
            the keywords is not important)
          </p>
          <br />
          ...
          <p>
            BLYP &nbsp; - generalized gradient approximation (GGA) DFT
            functional; see Table 6.2: Density functionals available in ORCA.
          </p>
          <p>
            DKH2 &nbsp; - scalar relativistic Douglas-Kroll-Hess Hamiltonian of
            2nd order; see Table 6.2: Density functionals available in ORCA.
          </p>
          <p>
            def2-SVP &nbsp; - basis set for H-Rn; see Table 9.8: Basis sets
            availability.
          </p>
          <p>
            def2/J &nbsp; - Coulomb-fitting auxiliary basis sets (AuxJ); see
            Table 9.8: Basis sets availability.
          </p>
          <p>
            UKS &nbsp; - selects spin unrestricted SCF method; Table 6.1: Main
            keywords that can be used in the simple input of ORCA.
          </p>
          <p>RKS &nbsp; - selects restricted closed-shell SCF method.</p>
          <br />

          <p>
            Reading geometry from file.xyz in XMol format with coordinates in
            Ångström and a 2-line header that contains the number of atoms and a
            description line:
          </p>
          <br />
...
"
          ...
          <li>
            ...
            <input
              ...
              @change="
                setStructureFile($event);
                overviewBuilder($event);
              "
            />
            <button
      ...
      <section id="fdmnesTab" :style="{ display: fdmnesDisplay }">
        <div style="float:right; width:40%; height:30%">
          <p>
            FDMNES (Finite Difference Method Near Edge Structure) is to provide
            a user friendly code, which is able to simulate a broad range of
            x-ray spectroscopies, beyond the muffin tin approximation. This ab
            initio (first principles) approach which is based upon the finite
            difference method, aims to eliminate all methodological parameters
            and go beyond the limitations of the spherical muffin tin
            approximation. It includes density functional theory and
            time-dependent density functional theory.
          </p>
          <span
            >FDMNES webpage:
            <a href="http://fdmnes.neel.cnrs.fr/"
              >http://fdmnes.neel.cnrs.fr/</a
            ></span
          >
          <br />
          <span
            >FDMNES theory and input:
            <a
              href="https://research.ncl.ac.uk/media/sites/researchwebsites/collaborativenetworkforx-rayspectroscopy/Joly_FDMNES_CONEXS_Newcastle.pdf"
              >HJoly_FDMNES_CONEXS_Newcastle.pdf</a
            ></span
          >
          <br /><br />
          <p>
            If you publish calculation results performed with FDMNES code please
            cite the original papers:
          </p>
      ...
      >
        <div style="float:right; width:40%; height:30%">
          ...
          <p>
            <span
              ...
              <a href="https://www.quantum-espresso.org/"
                >https://www.quantum-espresso.org</a
              ></span
            >
            <br />
            <span
              >Pw.x input descriptions:
              <a href="https://www.quantum-espresso.org/Doc/INPUT_PW.html"
                >https://www.quantum-espresso.org/Doc/INPUT_PW.html</a
              ></span
            >
            <br />
            <span
              >XSPECTRA input descriptions:
              <a
                href="https://github.com/QEF/q-e/blob/master/XSpectra/Doc/INPUT_XSPECTRA"
                >https://github.com/QEF/q-e/blob/master/XSpectra/Doc/INPUT_XSPECTRA</a
              ></span
            >
            <br /><br />
          </p>
          ...
          <br /><br />
          <p>
            X-ray absorption simulations in quantum espresso are carried out in
            two steps. Firstly using the pw.x code and then using the xspectra.x
            code. The input files for these to codes are ASCII files separated
            into cards (or blocks). The beginning of a block is denoted by an &
            symbol and the name of the card, the card is closed with a "/", for
            example:
          </p>
          <p>&CONTROL … /.</p>
          <p>
            For pw.x the input cards must be given in the order: control,
            system, electrons. Information on the geometry is given in the input
            file and can be provided as a set of atomic coordinates in Angstrom
            and a set of cell parameters also in Angstroms.
          </p>
          <br /><br />
          <p>
            Materials Project provides open web-based access to computed
            information on known and predicted materials.
          </p>
          <span
            ><a href="https://materialsproject.org/"
              >https://materialsproject.org/</a
            ></span
          >
          <p>
            If you use the Materials Project as a resource in your research,
                ...
                <template slot="addRow" slot-scope="{ row }">
                  ...
                  <td>
                    <input
                      v-model="atomX"
                      v-validate="
                        'required|decimal|min_value:-100|max_value:100'
                      "
                      type="text"
                      name="atomX"
        ...
        >
          <ul>
            ...
            <li>
              <label class="left"
                >Which atom is absorbing (counting from 1)?:</label
              >
              <input
                v-model="mpApiAtom"
                type="number"
      ...
      <ul>
        ...
        <li>
          <label v-if="quantumEspressoDisplay != 'inline'" class="left"
            >Atoms:</label
          >
          <table-component
        ...
        <li>
          ...
          <button type="button" class="button" @click="downloadFileContents()">
            Download
          </button>
        </li>
        <li v-if="orcaDisplay == 'inline'">
          <label class="left">Spectrum Type:</label>
          <select v-model="orcaSpectrumType" name="orcaSpectrumType">
        ...
        <li v-if="orcaDisplay == 'inline'">
          ...
          />
          &nbsp;
          <label class="notleft" style="font-size:14px; color:red">
            Please tick here to comply with ORCA license agreement
            <a href="https://orcaforum.kofo.mpg.de/app.php/privacypolicy/policy"
              >https://orcaforum.kofo.mpg.de/app.php/privacypolicy/policy</a
            ></label
          >
        ...
        <li style="vertical-align:middle; position: relative;">
          ...
          <input
            ...
            @change="overviewBuilder()"
          />
          <span v-if="errors.has('cpus')" class="errormessage ferror">{{
            errors.first("cpus")
          }}</span>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span v-if="errors.has('memory')" class="errormessage ferror">{{
            errors.first("memory")
          }}</span>
          <button
            type="button"
            ...
            name="orcaSubmit"
            :disabled="
              isSubmitDisabled || (!orcaLicense && orcaDisplay == 'inline')
            "
        ...
        <li>
          <span style="font-size:13px"
            >On successful submission, your results will be sent to the e-mail
            address associated with your fedid</span
          >
        </li>
...
export default {
  ...
  data: function() {
    return {
      ...
      elements: [
        {
          ...
          number: 1,
          mass: 1.0078,
          pseudopotential: "H.pbe-rrkjus_gipaw.UPF",
        },
        {
          element: "He",
          number: 2,
          mass: 4.0026,
          pseudopotential: "He.pbe-rrkjus_gipaw.UPF",
        },
        {
          element: "Li",
          number: 3,
          mass: 6.94,
          pseudopotential: "Li.pbe-s-rrkjus_gipaw.UPF",
        },
        {
          element: "Be",
          number: 4,
          mass: 9.0122,
          pseudopotential: "Be.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "B",
          number: 5,
          mass: 10.81,
          pseudopotential: "B.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "C",
          number: 6,
          mass: 12.011,
          pseudopotential: "C.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "N",
          number: 7,
          mass: 14.007,
          pseudopotential: "N.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "O",
          number: 8,
          mass: 15.999,
          pseudopotential: "O.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "F",
          number: 9,
          mass: 18.9984,
          pseudopotential: "F.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "Ne",
          number: 10,
        ...
        },
        {
          ...
          number: 15,
          mass: 30.9738,
          pseudopotential: "P.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "S",
          number: 16,
          mass: 32.06,
          pseudopotential: "S.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "Cl",
          number: 17,
        ...
        },
        {
          ...
          number: 32,
          mass: 72.63,
          pseudopotential: "Ge.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "As",
          number: 33,
        ...
        },
        {
          ...
          number: 52,
          mass: 127.6,
          pseudopotential: "Te.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "I",
          number: 53,
          mass: 126.905,
          pseudopotential: "I.pbe-n-rrkjus_gipaw.UPF",
        },
        {
          element: "Xe",
          number: 54,
      ...
      orbWin1Stop: 0,
      orcaSpectrumType: "",
      orcaMapKeyword: ["", "ABS", "ABSQ", "XES", "XESQ", "XAS", "XASQ"],
      orcaStartValue: 0,
      orcaStopValue: 1000,
      orcaBroadening: 1,
      ...
      fdmnes_abs_edge: ["K", "L1", "L2", "L3", "M1", "M2", "M3", "M4", "M5"],
      fdmnes_method: "",
      crystal: "",
      fdmnesParameterHeaders: [
        { key: "A", title: "A" },
        { key: "B", title: "B" },
        { key: "C", title: "C" },
      ...
      qeAtomHeaders: [
        ...
        { key: "Y", title: "Y" },
        { key: "Z", title: "Z" },
        { key: "AbsorbingAtom", title: "Absorbing Atom?" },
      ],
      absorbingAtom: false,
  ...
  methods: {
    ...
    pollClusterStatus: function() {
      ...
      Backbone.ajax({
        ...
        success: function(response) {
          ...
          if (
            self.clusterStatus == "Sleeping" ||
            self.clusterStatus == "Running"
          ) {
            self.isSubmitDisabled = false;
          } else {
            self.isSubmitDisabled = true;
    ...
    overviewBuilder: function(event) {
      if (this.orcaDisplay == "inline") this.orcaOverviewBuilder(event);
        ...
        console.log(
          "Unspecified tab is displaying, no overviewBuilder function available"
        );
    },
    ...
    orcaOverviewBuilder: function(event) {
      if (this.technique == "Xas") {
        this.output =
          "! " + this.functional + " DKH2 " + this.basis + " SARC/J ";
        ...
        this.output =
          "! UKS " + this.functional + " DKH2 " + this.basis + " SARC/J ";
      ...
      if ((event && event.target.files[0]) || this.structureFile) {
        var structureFileName = this.structureFile
        ...
        if (structureFileName.endsWith(".xyz")) {
          ...
          app.alert({
            title: "error",
            message: "Orca structure file must be .xyz or .gmnt",
          });
          this.$refs.fdmnesStructureFile.value = "";
          this.$refs.orcaStructureFile.value = "";
        }
    ...
    fdmnesOverviewBuilder: function(event) {
      ...
      this.output +=
        "-10. 0.25 50" +
        "       !E_min, step, E_intermediate, step ..." +
        "\n\n";
      this.output += "Edge" + "\n";
      ...
      this.output +=
        "SCF" + "        !Performs self-consistent calculation" + "\n";
      this.output +=
        "Energpho" +
        "       !Output energy relative to the photon energy of absorbing atom" +
        "\n\n";
      this.output += this.fdmnes_method ? "Green\n" : "";
      this.output += "Quadrupole" + "\n";

      if (this.edge.includes("L")) this.output += "Spinorbit" + "\n\n";
      else this.output += "\n";

      this.output +=
        "Radius" +
        "     ! Radius of the cluster where final state calculation is performed" +
        "\n";
      this.output += "6" + "\n\n";
      ...
      if ((event && event.target.files[0]) || this.structureFile) {
        ...
        if (structureFileName.endsWith(".cif")) {
          ...
          app.alert({
            title: "error",
            message: "Structure file must be .cif or .pdb",
          });
          this.$refs.fdmnesStructureFile.value = "";
          this.$refs.orcaStructureFile.value = "";
        }
        ...
        if (this.crystal == "Crystal")
          this.output +=
            "Crystal" +
            "        ! Periodic material description (unit cell)" +
            "\n";
        else if (this.crystal == "Molecule")
          this.output +=
            "Molecule" +
            "       ! Periodic or cylindrical or spherical coordinates" +
            "\n";

        this.output +=
          this.fdmnesParams[0].A +
          " " +
          this.fdmnesParams[0].B +
          " " +
          this.fdmnesParams[0].C +
          " " +
          this.fdmnesParams[0].Alpha +
          " " +
          this.fdmnesParams[0].Beta +
          " " +
          this.fdmnesParams[0].Gamma +
    ...
    quantumEspressoOverviewBuilder: function(event) {
      ...
      this.atomData.forEach(function(item, index) {
        self.ppElements.forEach(function(el, idx) {
          if (
            (el.element == item.Atom && !ppe.includes(el.element)) ||
            (el.element == item.Atom && item.AbsorbingAtom == "Yes")
          ) {
            if (item.AbsorbingAtom == "Yes") {
              self.output +=
                el.element + "* " + el.mass + " " + el.pseudopotential + "\n";
              ppe.push(el.element + "*");
            } else {
              self.output +=
                el.element + " " + el.mass + " " + el.pseudopotential + "\n";
      ...
      this.atomData.forEach(function(item, index) {
        ...
        if (item.AbsorbingAtom == "Yes")
          self.output +=
            item.Atom + "* " + item.X + " " + item.Y + " " + item.Z + "\n";
        else
          self.output +=
            item.Atom + " " + item.X + " " + item.Y + " " + item.Z + "\n";
      });
    ...
    resizeOverview: function() {
      ...
      for (var i = 0; i < rows.length; i++) {
        if (rows[i].length > longestRow) longestRow = rows[i].length;
      }
      ...
      this.$validator.validateAll().then(function(result) {
        ...
        if (result && self.inputFileContents != "") {
          ...
          Backbone.ajax({
            ...
            success: function(response) {
              ...
              if (!response.error) {
                ...
                app.alert({
                  className: "message notify",
                  message: "Successfully submitted conexs file contents!",
                });
              } else {
          ...
          app.alert({
            title: "Error",
            message:
              "No file provided, selected file is empty, or form elements are invalid.",
          });
        }
      });
    },
      ...
      if (this.atom) {
        if (this.form == "qe") {
          ...
          this.atomData.forEach(function(item, index) {
            if (
              (item.Atom == self.atom &&
                item.AbsorbingAtom == "Yes" &&
                self.absorbingAtom) ||
              (item.Atom == self.atom &&
                item.AbsorbingAtom == "No" &&
                !self.absorbingAtom)
            ) {
              exists = true;
            }
        ...
        if (this.absorbingAtom) this.absorbingAtomDisabled = true;
    ...
    removeAtom: function(atomID) {
      ...
      if (this.form == "qe") {
        ...
        this.atomData.forEach(function(item, index) {
          if (
            (item.Atom == atomName &&
              absorbingAtomLocal == "Yes" &&
              item.AbsorbingAtom == "Yes") ||
            (item.Atom == atomName &&
              absorbingAtomLocal == "No" &&
              item.AbsorbingAtom == "No")
          ) {
            exists = true;
          }
    ...
    killJob: function(jobID) {
      ...
      Backbone.ajax({
        ...
        error: function(response) {
          ...
          app.alert({
            title: "Error",
            message: "Failed to kill job, please try again later",
          });
        },
      });
    },
