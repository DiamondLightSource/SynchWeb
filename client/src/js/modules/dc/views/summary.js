    ...
    return Marionette.LayoutView.extend({
        ...
        onRender: function() {
            ...
            var columns = [
                ...
                { name: 'CELL', label: 'Unit Cell', cell: table.TemplateCell, template: '<%-CELL_A%>Å (<%-CELL_AL%>°)<br /><%-CELL_B%>Å (<%-CELL_BE%>°)<br /><%-CELL_C%>Å (<%-CELL_GA%>°)', editable: false },
                { name: 'RES', label: 'Resolution', cell: table.TemplateCell, template: '<%-OVERALLRLOW%>Å - <%-OVERALLRHIGH%>Å<br /><%-INNERRLOW%>Å - <%-INNERRHIGH%>Å<br /><%-OUTERRLOW%>Å - <%-OUTERRHIGH%>Å', editable: false },
