...
function(Marionette, 
  ...
  var EmptyCollectionView = Marionette.View.extend({ className: 'data_collection', template: _.template('<div><h1>No data collections yet</h1></div>') })
  var GettingCollectionView = Marionette.View.extend({ className: 'data_collection', template: _.template('<div><h1><i class="fa fa-spin fa-cog"></i> Retrieving data collections</h1></div>') })
  var EmptySearchView = Marionette.View.extend({ className: 'data_collection', template: _.template('<div><h1>No data collections found</h1></div>') })
