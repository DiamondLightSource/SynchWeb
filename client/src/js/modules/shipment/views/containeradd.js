    ...
    return FormView.extend({
        ...
        setType: function(e) {
            ...
            if (this.type.get('name') == 'Puck') {
                ...
                this.stable = new SampleTableView({ proteins: this.proteins, gproteins: this.gproteins, collection: this.samples, childTemplate: row, template: table, auto: this.ui.auto.is(':checked'), spacegroups: this.ui.spacegroups.is(':checked') })
                ...
                this.buildCollection()
                this.stable = new SampleTableView({ proteins: this.proteins, gproteins: this.gproteins, collection: this.samples, childTemplate: row, template: table, type: 'non-xtal', spacegroups: this.ui.spacegroups.is(':checked') })
                this.table.show(this.stable)
                this.single.empty()
                this.grp.empty()
                this.ui.pc.show()
