    ...
    return FormView.extend({
        ...
        setType: function(e) {
            ...
            if (this.type.get('name').toLowerCase().indexOf('puck') > -1) {
                ...
                this.getRegion('puck').$el.css('width', app.mobile() ? '100%' : '25%')
                this.getRegion('puck').show(new PuckView({ collection: this.samples, capacity: this.model.get('CAPACITY') }))
                ...
                this.getRegion('single').empty()
                this.getRegion('grp').empty()
                this.ui.pc.show()
                ...
                this.getRegion('puck').$el.css('width', app.mobile() ? '100%' : '50%')
                this.getRegion('puck').show(new PlateView({ collection: this.samples, type: this.type, showValid: true }))
                this.buildCollection()
                ...
                if (!app.mobile()) this.getRegion('puck').$el.css('width', app.mobile() ? '100%' : '50%')
                this.getRegion('puck').show(new PlateView({ collection: this.samples, type: this.type, showValid: true }))
                ...
                this.getRegion('single').show(this.singlesample)
                this.group = new ScreenGroupView({ components: this.screencomponents, editable: false })
                this.getRegion('grp').show(this.group)
                this.ui.pc.hide()
                this.buildCollection()
                this.$el.find('li.pck').hide()
                this.$el.find('li.pcr').hide()
        ...
        doOnShow: function() {
            ...
            //this.getRegion('puck').show(new PuckView({ collection: this.samples }))
