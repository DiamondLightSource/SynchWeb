...
export default function (name, parameters) {
    ...
    parameters.extract_small_boxsize = extract_small_boxsize === null ?
        'Box size is too large!' : extract_small_boxsize.toString()
}
