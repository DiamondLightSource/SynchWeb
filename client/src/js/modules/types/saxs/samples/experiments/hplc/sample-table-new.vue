  ...
  <div class="content">
    ...
    <table-component
      ...
      <template slot="content" slot-scope="{ row }">
        ...
        <validation-provider tag="td" v-slot="{ errors }">
        ...
        <validation-provider tag="td" rules="alpha_dash|max:1000" name="Comments" :vid="'comments-'+row['LOCATION']" v-slot="{ errors }">
...
export default {
  ...
  created: function() {
    ...
    console.log("Sample Table new hplc")
  },
}
</script>