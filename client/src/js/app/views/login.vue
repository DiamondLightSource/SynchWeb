<template>
    <div id="vue-login" class="content">
        ...
        <h1 data-testid="login-text">Login</h1>
            ...
            <form class="tw-w-full tw-mt-8">
                <ul>
                    ...
                    <li class="tw-flex-col md:tw-flex-row tw-mb-4">
                        ...
                        <button :disabled="invalid" class="tw-px-8 tw-py-2 tw-w-64 tw-border tw-border-gray-400 button submit" v-on:click.prevent="onSubmit" data-testid="login-submit" id="login-submit">Login</button>
                    </li>
                </ul>
            </form>
        </validation-observer>
