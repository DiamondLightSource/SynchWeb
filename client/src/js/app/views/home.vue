    ...
    <div class="tw-mx-auto">
      ...
      <div class="tw-flex tw-flex-col w-w-full tw-m-2 tw-p-4">
        <p class="tw-text-center tw-text-lg tw-mb-4">
          ...
          >
            Login
          </router-link> to view your proposals and sessions
        </p>
        <p
          v-if="dataCatalogue"
          class="tw-text-center tw-text-lg"
        >
          If you are looking for archived data please visit the data catalogue <a
            :href="dataCatalogue.url"
            class="tw-underline"
          >{{ dataCatalogue.name }}</a>
        </p>
      </div>
    </div>
  </section>
