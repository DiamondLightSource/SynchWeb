<template>
  ...
  <div v-show="isLoggedIn && showMenu">
    ...
    <div
      class="tw-absolute tw-flex tw-flex-col tw-z-10"
    ...
    >
      ...
      <router-link
        to="#"
        class="tw-relative tw-py-3 tw-bg-sidebar-mobile-background hover:tw-bg-gray-100 tw-border-t tw-border-gray-400 tw-text-white tw-text-left tw-text-xs tw-px-2"
      >
        <p class="">
          <i
      ...
      <router-link
        ...
        :key="index"
        :to="item.link | link"
        class="tw-py-3 tw-bg-sidebar-mobile-background hover:tw-bg-gray-100 tw-border-t tw-border-gray-400 tw-text-white tw-text-left tw-text-xs tw-px-2"
      >
        {{ item.name }}
      </router-link>
