<!--
    Marionette Dialog Box
-->
<template>
    <!-- This is a placeholder to show dialog boxes from marionette views -->
    <div id="dialog" class="tw-fixed tw-w-full tw-h-full tw-bg-transparent tw-top-0 tw-z-50 tw-left-0 tw-table tw-bottom-0">
...
import DialogRegion from 'views/dialogregion'
    ...
    computed: {
        widthClass() {
            const widthObject = {
                ...
                large: 'large-modal',
                'x-large': 'x-large-modal'
            }

            return widthObject[this.size]
        }
    },
    created: function() {
