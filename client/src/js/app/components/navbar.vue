        ...
        <div class="navbar-menu tw-z-10">
          ...
          >
            ...
            <li
              ...
              :key="index"
              class="tw-w-full tw-bg-sidebar-grad-end hover:tw-bg-sidebar-hover-background"
            >
              <router-link
                :to="item.link | link"
                class="tw-block tw-text-gray-900 tw-py-4 tw-px-2 tw-text-left"
              >
                {{ item.name }}
              </router-link>
            </li>
        ...
        <div class="navbar-menu">
          ...
          >
            <li class="tw-w-full tw-bg-sidebar-grad-end hover:tw-bg-sidebar-hover-background">
              <router-link
                to="/docs"
                class="tw-block tw-py-4 tw-text-gray-900 "
              >
                Tutorials
              </router-link>
            </li>
