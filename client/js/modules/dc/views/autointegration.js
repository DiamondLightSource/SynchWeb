        ...
        onRender: function() {
            ...
            this.summary.show(new TableView({
                ...
                columns: [
                    ...
                    { label: 'Rmeas Inner', cell: table.TemplateCell, editable: false, template: '<%-SHELLS.innerShell.RMEAS%>' },
                    { label: 'Rmeas Outer', cell: table.TemplateCell, editable: false, template: '<%-SHELLS.outerShell.RMEAS%>' },
