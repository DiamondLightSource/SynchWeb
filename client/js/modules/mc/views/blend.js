    ...
    return Marionette.LayoutView.extend({
        ...
        initialize: function(options) {
            ...
            var columns = [
                ...
                { name: 'ISIGI', label: 'I/\963(I)', cell: 'string', editable: false },
                ...
                { label: 'I/\963(I)', cell: table.TemplateCell, editable: false, test: 'SUCCESS', template: '<%=STATS.ISIGI[1]%>(<%=STATS.ISIGI[3]%>)' },
